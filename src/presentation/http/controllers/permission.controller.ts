...
import { ShareDocumentUseCase } from "/workflow/share-document.use-case";
import { RevokeDocumentAccessUseCase } from "/workflow/revoke-document-access.use-case";
import { GetDocumentPermissionsUseCase } from "/workflow/get-document-permissions.use-case";
import { 
  shareDocumentSchema,
